...
import { Channel, ExtendedChannel, LabelInheritableChannel, PolarPositionScaleChannel, PositionScaleChannel } from './channel.js';
...
export declare function getAncestorLevel(avoid: LabelAvoid): number;
